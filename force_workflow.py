...
base_path = '/rvt_mount/mowing_detection'                                               # Base Path where ./process/ folder structure should be created
project_name = "test"                                                   # Project Name defined for vitalitat_3cities_data storage
...
aois = glob.glob("/rvt_mount/3DTests/data/harm_data/ilmenau.shp")      # Define multiple or single AOI-Shapefile
...
##############################
#params_path = "/rvt_mount/vitalitat_3cities_data_slope/process/temp/dingolfing/FORCE/Dingolfing_gmd_ex_3035.shp/tsa_UDF.prm"
